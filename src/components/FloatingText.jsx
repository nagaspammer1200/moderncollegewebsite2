...
const FloatingText = () => {
  ...
  return (
    <div className={darkMode?"bg-dark floatingtextcontainerbox text-warning border-top border-2 border-primary":"bg-warning text-black floatingtextcontainerbox border-top border-2 border-success"}>
        <div className="floatingtextcontainer">
            ...
            <div className="floatingtextcontaineritem"><p><b>Summer Vacation In June</b></p></div>
            <div className="floatingtextcontaineritem"><p><b>University Exams Start in July!</b></p></div>
        </div>
    </div>
  )
}
