        ...
        <div>
          ...
          <div className="d-flex personcontainer3 p-3">
            <div className="p-3 ms-4">
                <div className="text-primary mb-3"><h3>Women Cell</h3></div>
                ...
                <div className="d-flex mb-3 gap-5  nsscontainer1">
                    ...
                    <div><img src="src/images/wc/wc1.jpg" width="250px" height="200px" alt="ISTE Meeting" /></div>
                </div>
                <div className="d-flex mb-3 gap-5  nsscontainer1">
                    <div>
                    ...
                    <div><img src="src/images/wc/wc2.jpg" width="250px" height="200px" alt="ISTE Meeting" /></div>
                </div>
            </div>
            <AnnouncementsBar/>
          </div>
