    ...
    <div>
        <div>
          ...
          <div className={darkMode?"d-flex personcontainer3 p-3 border-top border-1 border-primary bg-dark":"d-flex personcontainer3 p-3"}>
            <div className="p-3">
                <div className="mb-5"><ImageSlider imgone="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/ee1.jpg?alt=media&token=8314e919-ccbd-4bf2-bbc1-e80d84587059" imgtwo="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/ee2.jpg?alt=media&token=d5993ca1-a906-40bd-8859-c64ec6276e8b" imgthree="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/ee1.jpg?alt=media&token=8314e919-ccbd-4bf2-bbc1-e80d84587059" imgfour="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/ee2.jpg?alt=media&token=d5993ca1-a906-40bd-8859-c64ec6276e8b" altone="Lab Work" alttwo="Laboratory" altthree="Lab Work" altfour="Laboratory"/></div>
                        ...
                        <div className="collapse mb-4" id="collapseExample5">
                            <div className={darkMode?"card card-body bg-dark border-white border-1 border":"card card-body"}>
                                ...
                                <div className={darkMode?"mb-5 gap-5 nsscontainer1 text-info":"mb-5 gap-5 nsscontainer1"}>
                                    ...
                                    <div><img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/ee2.jpg?alt=media&token=d5993ca1-a906-40bd-8859-c64ec6276e8b" width="250px" height="200px" alt="Students inside the Machines Lab" /></div>
                                </div>
                                ...
                                <div className={darkMode?"mb-5 gap-5 nsscontainer1 text-info":"mb-5 gap-5 nsscontainer1"}>
                                    ...
                                    <div><img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/ee3.jpg?alt=media&token=2bb5b34d-d489-47bb-bee9-7e3968380b32" width="250px" height="200px" alt="Electrical and Electronics Workshop" /></div>
                                </div>
                                ...
                                <div className={darkMode?"mb-5 gap-5 nsscontainer1 text-info":"mb-5 gap-5 nsscontainer1"}>
                                    ...
                                    <div><img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/ee4.jpg?alt=media&token=b1126f0d-baae-457d-964d-7e2acbec11cb" width="250px" height="200px" alt="Measurements Lab" /></div>
                                </div>
                                ...
                                <div className={darkMode?"mb-5 gap-5 nsscontainer1 text-info":"mb-5 gap-5 nsscontainer1"}>
                                    ...
                                    <div><img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/ee5.jpg?alt=media&token=a6912623-27be-41a7-a609-d0a30924fac4" width="250px" height="200px" alt="Digital Trainer Kit" /></div>
                                </div>
                                ...
                                <div className={darkMode?"mb-5 gap-5 nsscontainer1 text-info":"mb-5 gap-5 nsscontainer1"}>
                                    ...
                                    <div><img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/ee6.jpg?alt=media&token=04f4646a-e489-4e5b-a3d9-7fa0c59725e2" width="250px" height="200px" alt="Student using Equipment" /></div>
                                </div>
                                ...
                                <div className={darkMode?"mb-5 gap-5 nsscontainer1 text-info":"mb-5 gap-5 nsscontainer1"}>
                                    ...
                                    <div><img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/ee7.jpg?alt=media&token=9e58aced-f78c-4286-9155-a1bae48d24c9" width="250px" height="200px" alt="Measurements Lab" /></div>
                                </div>
                        ...
                        <div className="collapse mb-4" id="collapseExample6">
                            <div className={darkMode?"card card-body bg-dark border-white border-1 border":"card card-body"}>
                                ...
                                <div className={darkMode?"text-info mb-3 bg-dark gap-3":"text-primary mb-3 gap-3"}>
                                    <PersonDetails personimage="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/default.png?alt=media&token=9c4eb775-02ac-4ad0-bbb8-0eb8a7cffa14" personname="Francis M Fernandez" personnumber="9074866202" persondesignation="Professor" />
                                    <PersonDetails personimage="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/default.png?alt=media&token=9c4eb775-02ac-4ad0-bbb8-0eb8a7cffa14" personname="DINESH GOPINATH" personnumber="9633929573" persondesignation="Professor" />
                                    <PersonDetails personimage="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/default.png?alt=media&token=9c4eb775-02ac-4ad0-bbb8-0eb8a7cffa14" personname="ANJANA K R" personnumber=" 9746475534" persondesignation="Associate Professor" personemail="anjana.kr@gecbh.ac.in"/>
                                    <PersonDetails personimage="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/default.png?alt=media&token=9c4eb775-02ac-4ad0-bbb8-0eb8a7cffa14" personname="DR. VINOD V" personnumber=" 9446107586" persondesignation="Associate Professor"/>
                                </div>
                                <div className={darkMode?"text-warning mb-3 ms-3":"text-primary mb-3 ms-3"}><h3>Technical Staff</h3></div>
                                <div className={darkMode?"text-info mb-3 bg-dark gap-3":"text-primary mb-3 gap-3"}>
                                    <PersonDetails personimage="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/default.png?alt=media&token=9c4eb775-02ac-4ad0-bbb8-0eb8a7cffa14" personname="SRI. LINTO JOSE" personnumber="9447512029" persondesignation="Instructor Grade I" />
                                    <PersonDetails personimage="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/default.png?alt=media&token=9c4eb775-02ac-4ad0-bbb8-0eb8a7cffa14" personname="SRI. JAYAKUMAR S" personnumber=" 9496153244" persondesignation="Trade Instructor"/>
                                </div>
                            </div>
                        </div>
                    </div>
                <div className={darkMode?"d-flex p-3 text-info bg-dark border border-white border-1 mb-5 departmentcontainer":"d-flex p-3 text-white bg-primary mb-5 departmentcontainer"}> 
                    <div className="mb-5"><img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/fransis.jpg?alt=media&token=43576f08-bdae-4752-b1f9-d35fb3a6d5d7" width="150px" height="150px" alt="Francis" /></div>
                    <div>
