  ...
  return (
    <div>
        <div>
          ...
          <div><FixedNavbar/></div>
          <div className="bg-primary p-5 text-white"><h2>Department of Electrical & Electronics Engineering</h2></div>
            ...
            <div className="p-3">
                ...
                <div className="physicaldepartment p-3">
                    ...
                    <div className="cardcontainer mb-5">
                        ...
                        <div className="mb-2 p-3"><p><i>Impart quality education in Electrical and Electronics Engineering to produce outstanding professionals capable of tackling the challenges of the society.</i></p></div>
                        <div>
                            <p>
                ...
                <div className="mb-3">
                        ...
                        <div class="collapse" id="collapseExample1">
                            <div class="card card-body">
                                ...
                                <div className="text-secondary"><p>The students will become highly productive Electrical and Electronics engineers capable of addressing various technological challenges in the society.</p></div>
                                <div className="text-primary"><h4><u>PEO 2</u></h4></div>
                                <div className="text-secondary"><p>The students will be socially committed professional team players with strong ethical sense and communication skills.</p></div>
                                <div className="text-primary"><h4><u>PEO 3</u></h4></div>
                                <div className="text-secondary"><p>The students will continue their lifelong learning for innovating, designing and implementing efficient and sustained electrical and electronics engineering practices.</p></div>
                            </div>
                        </div>
                        <div class="collapse" id="collapseExample2">
                            <div class="card card-body">
                                <div className="text-primary"><h4><u>PSO 1</u></h4></div>
                                <div className="text-secondary"><p>i Identify technical issues related to generation, transmission, and distribution of electric power and propose alternative feasible solutions.</p></div>
                                <div className="text-primary"><h4><u>PSO 2</u></h4></div>
                                <div className="text-secondary"><p>ii Attain technical competence and confidence in design, develop, test, and implement Electrical & Electronics systems applying state-of-art technology with appropriate methods and tools.</p></div>
                                <div className="text-primary"><h4><u>PSO 3</u></h4></div>
                                <div className="text-secondary"><p>iii Apply the theoretical concepts and practical skills in contributing technical solutions to socially relevant problems, considering socio-economic and environmental aspects.</p></div>
                            </div>
                        </div>
                        ...
                        <div class="collapse" id="collapseExample5">
                            <div class="card card-body">
                                ...
                                <div className="text-primary mb-3 ms-3"><h3>Electrical and Electronics Workshop</h3></div>
                                <div className="mb-5 gap-5 nsscontainer1">
                                    ...
                                    <div><img src="src/images/departments/ee3.jpg" width="250px" height="200px" alt="Electrical and Electronics Workshop" /></div>
                                </div>
                                ...
                                <div className="mb-5 gap-5 nsscontainer1">
                                    ...
                                    <div><img src="src/images/departments/ee4.jpg" width="250px" height="200px" alt="Measurements Lab" /></div>
                                </div>
                                <div className="text-primary mb-3 ms-3"><h3>Digital Circuits Lab</h3></div>
                                <div className="mb-5 gap-5 nsscontainer1">
                                    ...
                                    <div><img src="src/images/departments/ee5.jpg" width="250px" height="200px" alt="Digital Trainer Kit" /></div>
                                </div>
                                <div className="text-primary mb-3 ms-3"><h3>Electrical Measurements and Instrumentation Lab</h3></div>
                                <div className="mb-5 gap-5 nsscontainer1">
                                    ...
                                    <div><img src="src/images/departments/ee6.jpg" width="250px" height="200px" alt="Student using Equipment" /></div>
                                </div>
                                <div className="text-primary mb-3 ms-3"><h3>Microprocessor Lab</h3></div>
                                <div className="mb-5 gap-5 nsscontainer1">
                                ...
                                <div className="text-primary mb-3 ms-3"><h3>Power Electronics Lab</h3></div>
                                <div className="mb-5 p-3"><p>The lab is equipped with IGBT chopper with 230/110V Transformer & DC Motor (2.5HP, 230V, 1500 rpm) 3 Phase IGBT power inverter with 1HP, 415V,50Hz, 3 phase Induction Motor SCR Trainer Kit, Solar Voltaic training system. The students use this lab for regular lab sessions, project works and research activities.</p></div>
                                <div className="text-primary mb-3 ms-3"><h3>Systems and Control Lab</h3></div>
                                <div className="mb-5 p-3"><p>The lab is equipped with AC& DC Servomotor, Flow Control Trainer , Syncro trainer,Temperature Process Controller, P,PI,PID control Trainer System Software-Matlab PC(5 Nos) and DSO.This lab is mainly used for UG Students.</p></div>
                                <div className="text-primary mb-3 ms-3"><h3>Power Systems Lab</h3></div>
                                <div className="mb-5 p-3"><p>The lab is equipped with different types of Relay testing kit, Insulation megger,Electromagnetic type Over Voltage Relay. This lab is meant for both PG and UG students and is utilised for regular lab session and project works.</p></div>
                                <div className="text-primary mb-3 ms-3"><h3>High Voltage Lab</h3></div>
                                <div className="mb-5 p-3"><p>This is a newly set up lab in the department and is mainly used for UG Students.This lab equipped with (0-60 kV) Manual Oil Test Kit,100kV High Voltage Tester With Sphere Gap Assembly, 30kVAC/40kV DC Test Kit. This lab</p></div>
                            </div>
                        </div>
