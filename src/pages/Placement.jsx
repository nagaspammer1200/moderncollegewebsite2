        ...
        <div>
          ...
          <div className="d-flex personcontainer2">
            <div className="nsscontainer p-2">
                <div className="text-primary mb-3"><h3>About CGPU</h3></div>
                <div><p><b>The Career Guidance & Placement Unit (CGPU) committee comprises of the Principal, the Coordinator, Faculty Members and Student representatives. Prof. Ramesh S, Associate Professor (ME) is the coordinator (TPO) who can be reached at remeshnair2000@gmail.com (Ph. 9895342277). <br /><br />The raison d’etre of the Career Guidance and Placement Unit (CGPU) is the overall development of the individual student and providing a platform to launch their careers. Specifically, each student graduating from GECB should</b><br />1. Have a positive and winning attitude
                    <br /><br />2. Be a professional who is able to work synergistically as part of a team and collective
                    <br /><br />3. Be able to appreciate diverse perspectives, handle conflicts and form a balanced worldview
                    <br /><br />4. Have it in them to dedicate time and wholehearted effort to the task at hand <br /><br />5. Be capable of expressing oneself lucidly in a variety of interactions – be it a presentation, an interview or a discussion</p></div>
                ...
                <div className="m-5"><img src="src/images/placement2.jpg" width="700px" height="600px" alt="Placement Companies" /></div>
