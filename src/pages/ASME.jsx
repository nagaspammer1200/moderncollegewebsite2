        ...
        <div>
          ...
          <div className="d-flex personcontainer3 p-1 ms-3">
            <div className="p-3">
                ...
                <div className="mb-5 p-3 text-secondary"><p>Sreekiran S <br />Chairman, ASME GECBH<br />+91 85473 24352 <br /><br />Prajeesh P<br />Vice Chairman, ASME GECBH<br />+91 90614 57867</p></div>
