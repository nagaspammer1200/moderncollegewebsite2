        ...
        <div>
          ...
          <div className={darkMode?"d-flex personcontainer3 p-3 bg-dark border-top border-1 border-primary":"d-flex p-3 personcontainer3"}>
            <div className="p-3">
                ...
                <div className="mb-5 asmeimage"><img src="asme1.jpg" width="450px" height="350px" alt="ASME Meeting" /></div>
                ...
                <div className="mb-5 asmeimage"><img src="asme2.jpg" width="85%" alt="ASME Project Members" /></div>
