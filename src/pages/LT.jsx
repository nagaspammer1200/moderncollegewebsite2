  ...
  return (
    <div>
        <div>
          ...
          <div><FixedNavbar/></div>
          <div className={darkMode?"bg-dark p-5 text-warning":"bg-primary p-5 text-white"}><h2>Language Lab</h2></div>
                ...
                <div className="accordion m-5" id="accordionExample">
                        ...
                        <div className="accordion-item">
                            ...
                            <div id="collapseFour" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div className={darkMode?"accordion-body text-info bg-dark ":"accordion-body"}><p>To bridge the gap between the initial skills of individuals and what they need to enter and succeed in postsecondary education and career-path employment.</p></div>
                            </div>
                        </div>
                </div>
            </div>
