  ...
  return (
    <div>
        <div>
          ...
          <div><FixedNavbar/></div>
          <div className="bg-primary text-white p-5"><h2>Language Lab</h2></div>
          <div className="d-flex personcontainer3 p-3">
            <div className="p-3 ms-4">
                <div className="mb-2 gap-5 nsscontainer1">
                ...
                <div className="accordion m-5" id="accordionExample">
                        ...
                        <div className="accordion-item">
                            ...
                            <div id="collapseFour" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div className="accordion-body"><p>To bridge the gap between the initial skills of individuals and what they need to enter and succeed in postsecondary education and career-path employment.</p></div>
                            </div>
                        </div>
                </div>
            </div>
