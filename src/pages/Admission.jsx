        ...
        <div>
          ...
          <div className={darkMode?"d-flex personcontainer3 bg-dark border-top border-1 border-primary":"d-flex personcontainer3"}>
            <div className={darkMode?"p-3 ms-4 bg-dark":"p-3"}>
                ...
                <div className={darkMode?"mb-3 p-3 text-info":"bg-primary mb-3 p-3 text-white"}><p>ഒന്നാം വർഷ ബി.ടെക്.-ൽ പ്രതീക്ഷിത ഒഴിവുകളിലേക്ക് 15-9-2023-നു ഉച്ചയ്ക്ക് 12 മണി മുതൽ 2 മണി വരെ സ്പോട് അഡ്മിഷൻ നടത്തുന്നതാണ്. 14-9-2023-ലെ സ്പോട്ട് അഡ്മിഷനിൽ പങ്കെടുത്തവർ, 15-9-2023-ലെ സ്പോട്ട് അഡ്മിഷനിൽ പങ്കെടുക്കാൻ ആഗ്രഹിക്കുന്നുവെങ്കിൽ വീണ്ടും രജിസ്റ്റർ ചെയ്യണമെന്ന് അറിയിക്കുന്നു. സ്പോട് അഡ്മിഷനിൽ പങ്കെടുക്കാൻ ആഗ്രഹിക്കുന്ന വിദ്യാർത്ഥികൾ എല്ലാ അസ്സൽ സർട്ടിഫിക്കറ്റുകളുമായി 15-9-2023 -നു ഉച്ചയ്ക്ക് 2 മണിക്ക് മുൻപായി കോളേജിൽ എത്തി നടപടികളിൽ പങ്കെടുക്കേണ്ടതാണ്. ഏതെങ്കിലും ഗവൺമെന്റ്/എയ്‌ഡഡ്‌ എൻജിനീയറിങ് കോളേജിൽ ചേർന്നിട്ടുള്ളവരാണെങ്കിൽ അഡ്മിഷൻ സ്ലിപ്പും സ്വാശ്രയ കോളേജുകളിൽ ചേർന്നിട്ടുള്ളവർ കോളേജിൽ നിന്നും NOC യും കൊണ്ടുവരേണ്ടതാണ്. അഡ്മിഷൻ സ്ലിപ്പ്/NOC അല്ലെങ്കിൽ അസ്സൽ ട്രാൻസ്ഫർ സർട്ടിഫിക്കറ്റ് (TC) കയ്യിൽ ഉള്ളവർക്ക് മാത്രമേ സ്പോട് അഡ്മിഷനിൽ പങ്കെടുക്കുവാൻ കഴിയൂ. അഡ്മിഷൻ കിട്ടുന്നവർ അപ്പോൾ തന്നെ മുഴുവൻ ഫീസും അടച്ച് പ്രാവേശനം പൂർത്തിയാക്കേണ്ടതാണ്.</p></div>
                <div className="text-primary pb-3 ps-2"><h3>B.Tech Admission 2023 - Centralised Spot Admission on Sunday 10-09-2023</h3></div>
                <div className={darkMode?"mb-3 p-3 text-info":"bg-primary mb-3 p-3 text-white"}><h4>Venue : Government Engineering College Thrissur, Millennium Auditorium</h4></div>
                <div className={darkMode?"mb-3 p-3 text-info":"bg-primary mb-3 p-3 text-white"}><h4>Time of Registration : 8.00AM to 12.00 Noon</h4></div>
                <div className={darkMode?"mb-3 p-3 text-info":"bg-primary mb-3 p-3 text-white"}><h4>For more information visit: <a href="https://gectcr.ac.in/centralised-spot-admission-2023-24/">Link</a></h4></div>
                <div className="text-primary pb-3 ps-2"><h3>Instructions and guidelines for third phase B. Tech Admission Process - 2023</h3></div>
                <div className={darkMode?"mb-3 p-3 text-info":"bg-primary mb-3 p-3 text-white"}><p>1. Candidates who are allotted through CEE for joining engineering courses in this institution are advised to strictly follow these instructions / guidelines. <br /><br />2. The date and time for joining engineering programs are listed below</p></div>
                ...
                <div className={darkMode?"mb-3 p-3 text-info":"bg-primary mb-3 p-3 text-white"}><p>3. Fees to be paid to University, PTA, College Bus Facility, etc. at the time of admission is listed below.</p></div>
                <div className="table-responsive tablecontainer mb-5">
                    <table className={darkMode?"table table-striped table-dark":"table table-striped"}>
                        <thead>
                            <tr>
                ...
                <div className="accordion m-5" id="accordionExample">
                    <div className="accordion-item">
                        ...
                        <div id="collapseOne" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div className={darkMode?"accordion-body bg-dark text-success":"accordion-body"}>
                                <p>1. Admit card of KEAM 2023<br /> <br />2. Data sheet of KEAM 2023<br /> <br />3. Allotment memo of this phase<br /> <br />4. Certificate to prove date of birth<br /> <br />5. Transfer certificate from the institution last attended and conduct certificate<br /> <br />6. Original mark list of Higher secondary or equivalent and the pass certificate of the qualifying examination (if issued)<br /> <br />7. Migration Certificate, if applicable (Other than HSE/VHSE)<br /> <br />8. Receipt of the fee remitted at the Online/ Head post office in Kerala<br /> <br />9. Eligibility certificate from any University in Kerala, in the case of candidate who have passed a qualifying examination other than HSE/VHSE conducted by Government of Kerala or the examination conducted by CBSE or ICSE board.<br /> <br />10. Physical fitness certificate in the relevant format given in Annexure XVII (b) of the prospectus 2023<br /> <br />11. Originals of all the documents/certificates uploaded during the online application<br /> <br />12. Any other documents required in the allotment as per notification<br /> <br /></p>
                            </div>
                        </div>
                    </div>
                </div>
