  ...
  return (
    <div>
        <div>
          ...
          <div><FixedNavbar/></div>
          <div className={darkMode?"textaninight bg-dark p-5 text-warning":"textaniday bg-primary p-5 text-white"}><h2>Intellectual Property Rights Cell</h2></div>
            ...
            <div className={darkMode?"rulecontainer3 bg-dark":"rulecontainer3"}>
                <div className="d-flex flex-column text-center">
                    ...
                    <div className="mb-5 ptaimage">
                        <img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/ipr.jpg?alt=media&token=5c72f1d6-02a1-43d6-8e40-b502121e35c1" width="500px" height="300px" alt="Intellectual Property Rights Cell" />
                    </div>
                    <div className={darkMode?"mb-5 text-secondary text-start text-info":"mb-5 text-secondary text-start"}>
