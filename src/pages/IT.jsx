            ...
            <div className="p-3">
                ...
                <div className="physicaldepartment p-3">
                    <div className="cardcontainer">
                        ...
                        <div className={darkMode?"mb-2 p-3 text-info":"mb-2 p-3"}><p><i>To be a centre of higher learning in Information Technology that imparts qualityclose engineering education and</i></p></div>
                        <div className="mb-5 ">
                            <p>
                    ...
                    <div className="cardcontainer mb-5">
                        ...
                        <div className={darkMode?"mb-2 p-3 text-info":"mb-2 p-3"}><p><i>Establish conducive learning environment in the field of Information Technology</i></p></div>
                        <div>
                            <p>
                ...
                <div className="mb-3">
                    ...
                    <div className="collapse" id="collapseExample">
                        <div className={darkMode?"card card-body bg-dark border-white border-1 border":"card card-body"}>
                            <div className={darkMode?"mb-5 p-3 text-info":"mb-5 p-3"}><p>The college now offers five full time B. Tech degree courses. The duration of the Under Graduate Programme is four years. As per the AICTE norms, the annual intake of each UG course is sixty.</p></div>
                            <div className="mb-5 ms-3"><img src="src/images/departments/it4.jpeg" width="85%" height="80%" alt="IEEE Members" /></div>
                            <div className={darkMode?"mb-5 p-3 text-info":"mb-5 p-3"}><p>The faculty and staff of the department are well qualified and many of them are alumni of IITs and NITs. Currently we have 3 Ph.D holders in our faculty list. The department has well-equipped labs with state-of–the art technologies.</p></div>
                    ...
                    <div className="collapse" id="collapseExample1">
                        <div className={darkMode?"card card-body bg-dark border-white border-1 border":"card card-body"}>
                            ...
                            <div className={darkMode?"text-info":"text-secondary"}><p>Achieve professional competency in the field of Information Technology to become successful IT solution providers and entrepreneurs.</p></div>
                            <div className={darkMode?"text-success":"text-primary"}><h4><u>PEO 2</u></h4></div>
                            <div className={darkMode?"text-info":"text-secondary"}><p>Acquire scientific and engineering knowledge to pursue higher education and research.</p></div>
                            <div className={darkMode?"text-success":"text-primary"}><h4><u>PEO 3</u></h4></div>
                            <div className={darkMode?"text-info":"text-secondary"}><p>Become professionals with effective interpersonal skills, leadership qualities and social concern.</p></div>
                        </div>
                    </div>
                    <div className="collapse" id="collapseExample2">
                        <div className={darkMode?"card card-body bg-dark border-white border-1 border":"card card-body"}>
                            <div className={darkMode?"text-success":"text-primary"}><h4><u>PSO 1</u></h4></div>
                            <div className={darkMode?"text-info":"text-secondary"}><p>Design, implement and manage efficient and secure networking solutions with state-of-the- art Information and Communication Technologies.</p></div>
                            <div className={darkMode?"text-success":"text-primary"}><h4><u>PSO 2</u></h4></div>
                            <div className={darkMode?"text-info":"text-secondary"}><p>Design and develop solutions for real world problems using suitable programming languages and appropriate platforms by following the best software engineering principles and methodologies.</p></div>
                            <div className={darkMode?"text-success":"text-primary"}><h4><u>PSO 3</u></h4></div>
                            <div className={darkMode?"text-info":"text-secondary"}><p>Develop innovative solutions in the emerging areas of Information Technology.</p></div>
                        </div>
                    </div>
