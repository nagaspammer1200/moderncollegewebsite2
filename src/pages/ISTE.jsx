        ...
        <div>
          ...
          <div className={darkMode?"d-flex personcontainer2 bg-dark border-top border-1 border-primary ps-5":"d-flex personcontainer2 ps-5"}>
            <div className="p-3">
                ...
                <div className="mb-3 text-center asmeimage"><img src="iste.jpg" width="500px" height="450px" alt="ISTE Members" /></div>
                ...
                <div className={darkMode?"mb-5 gap-5 nsscontainer1 text-info":"mb-5 gap-5 nsscontainer1"}>
                    ...
                    <div><img src="iste1.jpg" width="250px" height="200px" alt="ISTE Meeting" /></div>
                </div>
                ...
                <div className={darkMode?"mb-5 gap-5 nsscontainer1 text-info":"mb-5 gap-5 nsscontainer1"}>
                    ...
                    <div><img src="iste2.jpg" width="250px" height="200px" alt="ISTE Meeting" /></div>
                </div>
