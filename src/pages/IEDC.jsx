  ...
  return (
    <div>
        <div>
          ...
          <div><FixedNavbar/></div>
          <div className={darkMode?"bg-dark p-5 text-warning":"bg-primary p-5 text-white"}><h2>Innovation and Entrepreneurship Development Cell</h2></div>
                ...
                <div className="accordion m-5" id="accordionExample">
                        ...
                        <div className="accordion-item">
                            ...
                            <div id="collapseFive" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div className={darkMode?"accordion-body bg-dark":"accordion-body"}><div className={darkMode?"p-3 text-info":"p-3"}><p>Our team at IEDC Summit 2019, Asia's largest summit for aspiring Entrepreneurs, involved Invited Talks, Startup Exhibition and Activity Hub held at Sahrdaya College of Engineering and Technology, Thrissur on 19th October.</p></div>
