            ...
            <div>
                <div className="mb-4">
                    <div class="gap-1">
                        ...
                        Junior Board Of Governors 2019-20
                        </button>
                    </div>
                ...
                <div className="accordion m-5" id="accordionExample">
                        ...
                        <div className="accordion-item">
                            ...
                            <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div className="accordion-body"><div className="p-3"><p>Prelims of AD ASTRA - Space Quiz, the inaugural event of IEDC Aerospace Community was conducted for the students of GECB on 17 October 2019 in association with _Barton Quiz Club. A total of 14 enigmatic teams participated battling</p></div></div>
                            </div>
                        </div>
                        <div className="accordion-item">
                            <h2 className="accordion-header">
                            ...
                            <div id="collapseFour" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div className="accordion-body"><div className="p-3"><p>A talk session was conducted by Miss Nanma Gireesh,the cofounder of Nest Abide and the famous TedTalk speaker in connection with the Notebook Talk Series '19. We had an interactive session where the first years got to know the basics of entrepreneurship and the brainstorming session brought out the best ideas within them.Miss Nanma Gireesh was presented with a memento by CEO Adith Harikumar. The event was gifted with a highly attractive freshers of our college. Around 36 students participated in this event.</p></div></div>
                            </div>
                        </div>
                        <div className="accordion-item">
                            <h2 className="accordion-header">
                            <button className="accordion-button text-white bg-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                <div className="mb-3 d-flex"><i className="bi bi-record-circle"></i><div className="ms-5">IEDC Summit 2019</div></div>
                            </button>
                            </h2>
                            <div id="collapseFive" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div className="accordion-body"><div className="p-3"><p>Our team at IEDC Summit 2019, Asia's largest summit for aspiring Entrepreneurs, involved Invited Talks, Startup Exhibition and Activity Hub held at Sahrdaya College of Engineering and Technology, Thrissur on 19th October.</p></div>
                            <div><img src="src/images/iedc/iedc2.jpg" alt="IEDC Meeting" /></div></div>
                            </div>
                        </div>
                        <div className="accordion-item">
                            <h2 className="accordion-header">
