          ...
          <div className="d-flex personcontainer3">
            <div className="rulecontainer3">
                <div className="d-flex flex-column text-center">
                    ...
                    <div className="mb-5 text-secondary text-start listdiv">
                        <ul>
                            <li className="mb-2 p-2">Any conduct by any student or students whether by words spoken or written or by an act which has the e ect of teasing, treating or handling with rudeness to a fresher or any other student.</li>
                    ...
                    <div className="mb-5 text-secondary shadow p-2 text-start">
                        <ol>
                    ...
                    <div className="mb-5 p-3 text-secondary text-center border border-success border-5">
                        <div className="m-3"><p>24 HOURS HELP-LINE</p></div>
                        ...
                        <div className="m-3"><p>District Legal Service : 0471 2595173, 0471 3257335</p></div>
                        <div className="m-3"><p>E-mail : helpline@antiragging.net</p></div>
                    </div>
                    <div className="mb-5 text-primary text-start">
                    ...
                    <div className="mb-5 d-flex text-secondary bg-white text-start">
                        <div>
                            <ul  className="list-unstyled">
                                ...
                                <li className="mb-3 mt-3 p-2 text-dark">Representative of Parents	</li>
                                <li className="mb-3 mt-3 p-2 text-dark">Representative of Students</li>
                                <li className="mb-3 mt-3 p-2 text-dark">Representative of fresh students</li>
                                <li className="mb-3 mt-3 p-2 text-dark">Representative of students in hostel	</li>
