        ...
        <div>
          ...
          <div className={darkMode?"aboutcontainer bg-dark text-info":"aboutcontainer"}>
            <div className="card text">
              <div className="m-3"><img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/college_abt.jpg?alt=media&token=cb782885-9705-438d-a014-64fa5b330fbd" height="500px" className="card-img" alt="Image of GECBH"/></div>
            ...
            <div className="pcontainer">
              <div className="pitem">
                <div>
                  ...
                  <img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/college4.jpeg?alt=media&token=4a6a22e0-b72f-40e7-83dc-3199301da1c9" width="300px" height="250px" alt="College Image 2" />
                </div>
                <div className="mt-4">
              ...
              <div className="pitem">
                <div>
                  ...
                  <img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/history.jpg?alt=media&token=bfe94f2f-0e74-4574-8dc8-aa5460764ffd" width="300px" height="250px" alt="College History Image" />
                </div>
                <div className="mt-4">
