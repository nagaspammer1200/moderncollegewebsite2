        ...
        <div>
          ...
          <div className="aboutcontainer">
            <div className="card text-bg-dark w-70 h-50">
              <img src="src/images/about/college_abt.jpg" className="card-img w-70" alt="Image of GECBH"/>
            ...
            <div className="pcontainer">
              <div className="pitem">
                <div className="text-start p-3">
                  ...
                  <img src="src/images/about/college4.jpeg" className="w-60 h-60" alt="College Image 2" />
                </div>
                <div>
              ...
              <div className="pitem">
                <div className="text-start p-3">
                  ...
                  <img src="src/images/about/history.jpg" alt="College History Image" />
                </div>
                <div>
            ...
            <div>
              <div className="d-flex gap-3 p-5 m-1 structure">
                  ...
                  <div className="w-50 latimg">
                    <img src="src/images/about/people2.jpg" width="90%" height="100%"alt="Students" />
                  </div>
              </div>
              <div className="d-flex gap-3 p-5 m-1 structure">
                    <div className="w-50 rat">
                      <img src="src/images/about/masters.jpg" width="100%" height="100%"alt="Masters Degree" />
                    </div> 
              ...
              <div className="d-flex gap-3 p-5 m-1 structure">
                  ...
                  <div className="w-50 latimg">
                    <img src="src/images/about/faculty.jpg" width="90%" height="100%" alt="Teaching Staff" />
                  </div>
              </div>
              <div className="d-flex gap-3 p-5 m-1 structure">
                    <div className="w-50 rat">
                      <img src="src/images/about/admission.jpg" width="90%" height="100%" alt="Programmes" />
                    </div> 
                    <div className="p-3 rat2">
              ...
              <div className="d-flex gap-3 p-5 m-1 structure">
                  ...
                  <div className="w-50 latimg">
                    <img src="src/images/about/alumni.jpg" width="90%" height="100%" alt="Former Students" />
                  </div>
              </div>
            </div>
          </div>
