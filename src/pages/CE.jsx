            ...
            <div className="p-3">
                ...
                <div className="physicaldepartment p-3">
                    <div className="cardcontainer">
                        ...
                        <div className={darkMode?"mb-2 p-3 text-info":"mb-2 p-3"}><p><i>A centre of excellence having global recognition for outstanding education, socially relevant research and innovation in the field of Civil Engineering.</i></p></div>
                    </div>
                ...
                <div className="mb-3">
                        ...
                        <div className="collapse" id="collapseExample1">
                            <div className={darkMode?"card card-body bg-dark border-white border-1 border":"card card-body"}>
                                ...
                                <div className={darkMode?"text-info":"text-secondary"}><p>To produce well qualified professionals with a profound knowledge in Civil Engineering and principles of mathematics and science,, reaching advanced levels in Engineering and related fields.</p></div>
                                <div className={darkMode?"text-success":"text-primary"}><h4><u>PEO 2</u></h4></div>
                                <div className={darkMode?"text-info":"text-secondary"}><p>To enable students to effectively communicate and implement technological concepts and design and to work as a team in multidisciplinary environment to excel in their careers.</p></div>
                                <div className={darkMode?"text-success":"text-primary"}><h4><u>PEO 3</u></h4></div>
                                <div className={darkMode?"text-info":"text-secondary"}><p>To equip graduates in identifying, analysing and formulating solutions to complex engineering problems catering to global needs in the field of Civil Engineering, by applying modern, sustainable and eco-friendly technologies, adherent to societal moral values and professional ethics.</p></div>
                                <div className={darkMode?"text-success":"text-primary"}><h4><u>PEO 4</u></h4></div>
                                <div className={darkMode?"text-info":"text-secondary"}><p>To nurture students to be well prepared for the industry with core engineering competency, comprehensive knowledge of modern engineering tools and good managerial skills that will enable them to have a long term engineering / entrepreneurship careers.</p></div>
                            </div>
                        </div>
