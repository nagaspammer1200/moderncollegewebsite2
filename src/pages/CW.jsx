          ...
          <div className="d-flex personcontainer3 p-3">
            <div className="p-3 ms-4">
                ...
                <div className="d-flex mb-5 gap-5 nsscontainer1 ms-3">
                    <div>
                        <div className="mb-5"><p>The network traffic between the college intranet and the internet is monitored and controlled through a firewall. Cisco routers and switches are used at the backbone level of the intranet. A fiber-optic backbone has been laid to provide connectivity to various parts of the campus.</p></div>
                        <div className="mb-5"><p>The campus is completely connected by WiFi. A Ruckus ZoneDirector 3000 WiFi controller kept in the server room manages the WiFi access. Access points have been deployed throughout the campus so that online facilities like e-journals (which are provided on IP-based access) can be accessed from anywhere within the college premises.</p></div>
                    </div>
                    <div><img src="src/images/cw.jpg" width="250px" height="200px" alt="Campus WIfi" /></div>
                </div>
                <div className="mb-5"><p>TWi-Fi access will be available for all staff, students, guests</p></div>
                <div className="mb-5 text-dark ms-3"><p>The various departments/sections covered under Wi-Fi are:</p></div>
                <div className="mb-5 ms-3 listdiv2">
                    <ul>
                        <div className="ms-2"><li>Main Administrative building (All 7 floors including Library)</li></div>
                        <div className="ms-2"><li>Mechanical Lab Block (including ADAM, CADD Lab, PG Labs)</li></div>
                        <div className="ms-2"><li>New Drawing Hall & proposed CADD Room (Civil) over the Mech Lab Block</li></div>
                        <div className="ms-2"><li>EC/IT Block (All floors including the new IT Labs at 2nd floor)</li></div>
                        <div className="ms-2"><li>Mechanical Workshop</li></div>
                        <div className="ms-2"><li>New Computer Lab/CADD Lab (EEE dept)</li></div>
                        <div className="ms-2"><li>Old Server Room and Labs (IT Department)</li></div>
                        <div className="ms-2"><li>Proposed English Language Lab (Near old office)</li></div>
                        <div className="ms-2"><li>MTech Class Rooms (old office)</li></div>
                        <div className="ms-2"><li>PTA Building (All floors)</li></div>
                        <div className="ms-2"><li>Mini Auditorium</li></div>
                        <div className="ms-2"><li>Ladies Hostel (Lobby)</li></div>
                        <div className="ms-2"><li>All main outdoor areas in campus including Canteen, NSS Room etc.</li></div>
                    </ul>
                </div>
