  ...
  return (
    <div>
        <div>
          ...
          <div><FixedNavbar/></div>
          <div className={darkMode?"textaninight bg-dark p-5 text-warning":"textaniday bg-primary p-5 text-white"}><h2>Centre for Engineering Research and Development</h2></div>
