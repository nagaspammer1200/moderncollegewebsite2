        ...
        <div>
          ...
          <div className={darkMode?"d-flex personcontainer3 p-3 bg-dark border-top border-1 border-primary":"d-flex p-3 personcontainer3"}>
            <div className="p-3">
                ...
                <div className="mb-5 asmeimage"><img src="igs.jpg" width="450px" height="350px" alt="IGS Members" /></div>
                ...
                <div className="mb-5 asmeimage"><img src="igs1.jpg" width="450px" height="350px" alt="IGS Members" /></div>
                ...
                <div className="d-flex mb-5 gap-5 nsscontainer1 ms-3">
                    <div><img src="igs2.jpg" width="250px" height="200px" alt="NSS Introduction" /></div>
                    <div><img src="igs3.jpg" width="250px" height="200px" alt="NSS Introduction" /></div>
                </div>
