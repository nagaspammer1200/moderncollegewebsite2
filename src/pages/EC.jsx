  ...
  return (
    <div>
        <div>
          ...
          <div><FixedNavbar/></div>
          <div className="bg-primary p-5 text-white"><h2>Department of Electronics & Communication Engineering</h2></div>
                        ...
                        <div>
                            ...
                            <div className="mb-5">
                                <div className="collapse collapse-horizontal" id="collapseWidthExample">
                                    <div className="card card-body p-2" ><p>engineering. <br /><br />Promote innovation and aptitude for research by exposing students and faculty into new areas of technology.<br /><br />Provide an ethical and value-based education by encouraging activities addressing societal needs. <br /><br /></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="mb-3">
                        ...
                        <div class="collapse" id="collapseExample1">
                            <div class="card card-body">
                                ...
                                <div className="text-secondary"><p>To produce well qualified        professionals with a profound knowledge of technical fundamentals in Electronics and Communication as well as principles of mathematics and science, reaching for advanced degrees in engineering and related fields at internationally leading institutes.</p></div>
                                <div className="text-primary"><h4><u>PEO 2</u></h4></div>
                                <div className="text-secondary"><p>To equip graduates in identifying, analyzing, and formulating solutions to technological problems catering to the needs of society in field of electronics and communication engineering, adherent to societal moral values and professional ethics.</p></div>
                                <div className="text-primary"><h4><u>PEO 3</u></h4></div>
                                <div className="text-secondary"><p>To nurture graduates to be well prepared for the industry with core engineering competency, comprehensive knowledge of modern engineering tools and good managerial skills that will enable them to have a long term engineering / entrepreneurship careers.</p></div>
                            </div>
                        </div>
                        <div class="collapse" id="collapseExample2">
                            <div class="card card-body">
                                <div className="text-primary"><h4><u>PSO 1</u></h4></div>
                                <div className="text-secondary"><p>i Basic Knowledge: Represent, analyze and synthesize systems making use of theoretical knowledge, experimental data, and practical insight, arising in the fields of analog and digital integrated circuits, signal processing, communication, control, radio frequency applications and micro processor based applications.</p></div>
                                <div className="text-primary"><h4><u>PSO 2</u></h4></div>
                                <div className="text-secondary"><p>ii Technical Proficiency: Identify the advanced intra/inter disciplinary areas associated with electronics and communication engineering, informed by contextual knowledge on contemporary industry, research and societal needs, and formulated the related problems.</p></div>
                                <div className="text-primary"><h4><u>PSO 3</u></h4></div>
                                <div className="text-secondary"><p>iii Professional Soft skills: Adapt to the very fast technological changes in the field of electronics and communication engineering; be able to articulate the ideas and principles combining both mathematical precision and engineering intuition; be able to work in a collaborative environment keeping up ethical values.</p></div>
                            </div>
                        </div>
                        ...
                        <div class="collapse" id="collapseExample4">
                            <div class="card card-body">
                                ...
                                <div className="text-secondary"><p><i className="bi bi-star-fill"></i> M.Tech in Electronics and Communication Engineering with specialization in Signal Processing</p></div>
                                <div className="text-secondary"><p><i className="bi bi-star-fill"></i> Diploma course ADAM (Advanced Diploma in Automotive Mechatronics)</p></div>
                            </div>
                        </div>
                        <div class="collapse" id="collapseExample5">
                            <div class="card card-body">
                                <div className="text-primary mb-3 ms-3"><h3>Department Facilities</h3></div>
                                <div className="mb-5 p-3"><p>The following are the laboratory facilities of Electronics & Communication Engineering Department.</p></div>
                                <div className="text-primary mb-3 ms-3"><h3>Electronic Circuits Lab</h3></div>
                                ...
                                <div className="text-primary mb-3 ms-3"><h3>Digital Electronics Lab</h3></div>
                                <div className="mb-5 p-3"><p>The Digital Lab is well equipped with all the trainer kits and measuring instruments for the proper setting up of different Digital circuits and experiment. An IC tester is also available in the lab for testing of ICs.</p></div>
                                <div className="text-primary mb-3 ms-3"><h3>Communication Engineering Lab</h3></div>
                                <div className="mb-5 gap-5 nsscontainer1">
                                ...
                                <div className="text-primary mb-3 ms-3"><h3>Fiber Optics And Photonics Research Lab</h3></div>
                                <div className="mb-5 gap-5 nsscontainer1">
                                ...
                                <div className="text-primary mb-3 ms-3"><h5>Ongoing Research Work</h5></div>
                                <div className="mb-5 p-3"><p>1. Optisystem V13.0 Simulation Software with 3 user license. <br /><br />2. Erbium Doped Fiber Amplifier with accessories</p></div>
                                <div className="text-primary mb-3 ms-3"><h5>For UG students</h5></div>
                                <div className="mb-5 p-3"><p>The optical communication laboratory is setup to complement the topics studied in the optical communication theory course. The lab is equipped with fiber optic trainer kits and modules to enable the study of components of an optical communication system. The students perform experiments to study the characteristics of optical sources (LED & LD) and optical detectors (LD & APD) and optical fibers. Fault detection in a fiber link is studied using the OTDR module. A FSO module enables study of transmission of optical signal in free space. Optiwave simulator is also available in the lab which is an optical communication simulator.</p></div>
                                <div className="text-primary mb-3 ms-3"><h3>Microwave Lab</h3></div>
                                <div className="mb-5 p-3"><p>In Microwave Lab the students are exposed to the microwave active devices like klystron, gunn diode and passive devices isolator, circulator, slide screw tunner, magic tee, directional coupler, horn antenna, attenuator, terminations. The students perform all the experiments as prescribed by the university.</p></div>
                                <div className="text-primary mb-3 ms-3"><h3>Micro Controller/VLSI/Embedded Systems Lab</h3></div>
                                <div className="mb-5 p-3"><p>Microcontroller lab helps the students enhance their knowledge about various processors such as 8085, 8086, microcontrollers, Pentium processors and also the interfacing of these processors with other equipments. Students from other branch of engineering and sciences also come to this lab and develop their skills in the field of microprocessor and its applications. The features and facilities available in this lab will help the students do their projects and enhance their knowledge about the latest trends and technologies.  <br /><br />The VLSI and Embedded Systems Lab provides all the hardware and software resources useful for laboratory experiments related to various core and elective courses, such as: Digital Design, Computer Organization, Embedded System Design, VLSI Design, VLSI Sub-system Design etc.</p></div>
                                <div className="text-primary mb-3 ms-3"><h3>Nano Electronics Research Lab</h3></div>
                                <div className="mb-5 p-3"><p>Nanotechnology is a fast growing area with its application in various fields including electronics. A research lab is being set up for carrying out research projects for UG, PG and research students. The lab at present houses various equipments including sonicator, hot plates, muffled furnace, bench top cooling centrifuge and magnetic stirrers. The various ongoing projects here are synthesis of nanocomposites for various electronic applications, fabrication of solar cells, Synthesis and characterization of CNT based nanocomposites and their application in solar cells. Prof. Nelsa Abraham is leading this initiative.</p></div>
                                <div className="text-primary mb-3 ms-3"><h3>Electronics Workshop/Project Lab</h3></div>
                                <div className="mb-5 p-3"><p>The Workshop is sufficiently outfitted with all the equipments and accessories for conducting practical classes in wiring practices as per BIS specifications. Models of modern switchgear and wiring accessories are deployed for the benefit of the students. The electronic side deals with the familiarization of Cathode Ray Oscilloscope (CRO), Bread board connections, PCBs and Soldering station. The students are exposed to the current practices in domestic wiring and industrial installation.
