    ...
    <div>
        <div>
          ...
          <div className={darkMode?"d-flex personcontainer3 p-3 border-top border-1 border-primary bg-dark":"d-flex personcontainer3 p-3"}>
            <div className="p-3">
                <div className="mb-5"><ImageSlider imgone="ec1.jpg" imgtwo="ec2.jpg" imgthree="ec1.jpg" imgfour="ec2.jpg" altone="Laboratory" alttwo="Soldering" altthree="Lab Work" altfour="Soldering"/></div>
                        ...
                        <div className="collapse mb-4" id="collapseExample5">
                            <div className={darkMode?"card card-body bg-dark border-white border-1 border":"card card-body"}>
                                ...
                                <div className={darkMode?"mb-5 gap-5 nsscontainer1 text-info":"mb-5 gap-5 nsscontainer1"}>
                                    ...
                                    <div><img src="ec4.jpg" width="250px" height="200px" alt="Arduino on Laptop" /></div>
                                </div>
                                ...
                                <div className={darkMode?"mb-5 gap-5 nsscontainer1 text-info":"mb-5 gap-5 nsscontainer1"}>
                                    ...
                                    <div><img src="ec6.jpg" width="250px" height="200px" alt="Communication Engineering Lab" /></div>
                                </div>
                                ...
                                <div className={darkMode?"mb-5 gap-5 nsscontainer1 text-info":"mb-5 gap-5 nsscontainer1"}>
                                    ...
                                    <div><img src="ec7.jpg" width="250px" height="200px" alt="Arduino on Laptop" /></div>
                                </div>
                ...
                <div className={darkMode?"d-flex p-3 text-info bg-dark border border-white border-1 mb-5 departmentcontainer":"d-flex p-3 text-white bg-primary mb-5 departmentcontainer"}> 
                    <div className="mb-5"><img src="hari.jpg" width="150px" height="150px" alt="Haripriya" /></div>
                    <div>
