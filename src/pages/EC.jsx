            ...
            <div className="p-3">
                ...
                <div className="physicaldepartment p-3">
                    ...
                    <div className="cardcontainer mb-5">
                        ...
                        <div className={darkMode?"mb-5 p-3 text-info textcontainer4":"mb-5 p-3 textcontainer4"}><p><i>Establish a learning environment that enables students build the fundamentals and study advanced disciplines related to electronics and communication</i></p></div>
                        <div>
                            <p>
                ...
                <div className="mb-3">
                        ...
                        <div className="collapse mb-4" id="collapseExample4">
                            <div className={darkMode?"card card-body bg-dark border-white border-1 border":"card card-body"}>
                                ...
                                <div className={darkMode?"text-info textcontainer4":"text-secondary textcontainer4"}><p><i className="bi bi-star-fill"></i> M.Tech in Electronics and Communication Engineering with specialization in Signal Processing</p></div>
                                <div className={darkMode?"text-info textcontainer4":"text-secondary textcontainer4"}><p><i className="bi bi-star-fill"></i> Diploma course ADAM (Advanced Diploma in Automotive Mechatronics)</p></div>
                            </div>
                        </div>
                        <div className="collapse mb-4" id="collapseExample5">
                            <div className={darkMode?"card card-body bg-dark border-white border-1 border":"card card-body"}>
                                ...
                                <div className={darkMode?"mb-5 p-3 text-info textcontainer4":"mb-5 p-3 textcontainer4"}><p>The following are the laboratory facilities of Electronics & Communication Engineering Department.</p></div>
                                ...
                                <div className={darkMode?"mb-5 gap-5 nsscontainer1 text-info":"mb-5 gap-5 nsscontainer1"}>
                                    ...
                                    <div><img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/ec4.jpg?alt=media&token=b6ee5a87-2152-4145-aace-e55c8b7b21d4" width="250px" height="200px" alt="Arduino on Laptop" /></div>
                                </div>
                                <div className={darkMode?"text-warning mb-3 ms-3":"text-primary mb-3 ms-3"}><h3>Digital Electronics Lab</h3></div>
                                <div className={darkMode?"mb-5 p-3 text-info textcontainer4":"mb-5 p-3 textcontainer4"}><p>The Digital Lab is well equipped with all the trainer kits and measuring instruments for the proper setting up of different Digital circuits and experiment. An IC tester is also available in the lab for testing of ICs.</p></div>
                                ...
                                <div className={darkMode?"mb-5 gap-5 nsscontainer1 text-info":"mb-5 gap-5 nsscontainer1"}>
                                    ...
                                    <div><img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/ec6.jpg?alt=media&token=f4b55eca-5143-4f56-947d-106029975c4e" width="250px" height="200px" alt="Communication Engineering Lab" /></div>
                                </div>
                                ...
                                <div className={darkMode?"mb-5 p-3 text-info textcontainer4":"mb-5 p-3 textcontainer4"}><p>Microcontroller lab helps the students enhance their knowledge about various processors such as 8085, 8086, microcontrollers, Pentium processors and also the interfacing of these processors with other equipments. Students from other branch of engineering and sciences also come to this lab and develop their skills in the field of microprocessor and its applications. The features and facilities available in this lab will help the students do their projects and enhance their knowledge about the latest trends and technologies.  <br /><br />The VLSI and Embedded Systems Lab provides all the hardware and software resources useful for laboratory experiments related to various core and elective courses, such as: Digital Design, Computer Organization, Embedded System Design, VLSI Design, VLSI Sub-system Design etc.</p></div>
                                <div className={darkMode?"text-warning mb-3 ms-3":"text-primary mb-3 ms-3"}><h3>Nano Electronics Research Lab</h3></div>
                                <div className={darkMode?"mb-5 p-3 text-info textcontainer4":"mb-5 p-3 textcontainer4"}><p>Nanotechnology is a fast growing area with its application in various fields including electronics. A research lab is being set up for carrying out research projects for UG, PG and research students. The lab at present houses various equipments including sonicator, hot plates, muffled furnace, bench top cooling centrifuge and magnetic stirrers. The various ongoing projects here are synthesis of nanocomposites for various electronic applications, fabrication of solar cells, Synthesis and characterization of CNT based nanocomposites and their application in solar cells. Prof. Nelsa Abraham is leading this initiative.</p></div>
                                <div className={darkMode?"text-warning mb-3 ms-3":"text-primary mb-3 ms-3"}><h3>Electronics Workshop/Project Lab</h3></div>
                                <div className={darkMode?"mb-5 p-3 text-info textcontainer4":"mb-5 p-3 textcontainer4"}><p>The Workshop is sufficiently outfitted with all the equipments and accessories for conducting practical classes in wiring practices as per BIS specifications. Models of modern switchgear and wiring accessories are deployed for the benefit of the students. The electronic side deals with the familiarization of Cathode Ray Oscilloscope (CRO), Bread board connections, PCBs and Soldering station. The students are exposed to the current practices in domestic wiring and industrial installation.
                        ...
                        <div className="collapse mb-4" id="collapseExample6">
                            <div className={darkMode?"card card-body bg-dark border-white border-1 border":"card card-body"}>
                                ...
                                <div className={darkMode?"text-info mb-3 bg-dark gap-3":"text-primary mb-3 gap-3"}>
                                    <PersonDetails personimage="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/default.png?alt=media&token=9c4eb775-02ac-4ad0-bbb8-0eb8a7cffa14" personname="DR. HARI.R" personnumber="9447725443" persondesignation="Professor" />
                                    <PersonDetails personimage="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/default.png?alt=media&token=9c4eb775-02ac-4ad0-bbb8-0eb8a7cffa14" personname="DR.RAJEEV RAJAN" personnumber="9495816851" persondesignation="Associate Professor" />
                                    <PersonDetails personimage="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/default.png?alt=media&token=9c4eb775-02ac-4ad0-bbb8-0eb8a7cffa14" personname="DR. NELSA ABRAHAM" personnumber=" 9495975074" persondesignation="Associate Professor" />
                                </div>
                                <div className={darkMode?"text-warning mb-3 ms-3":"text-primary mb-3 ms-3"}><h3>Technical Staff</h3></div>
                                <div className={darkMode?"text-info mb-3 bg-dark gap-3":"text-primary mb-3 gap-3"}>
                                    <PersonDetails personimage="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/default.png?alt=media&token=9c4eb775-02ac-4ad0-bbb8-0eb8a7cffa14" personname="VINOD KUMAR P S" personnumber="+9446422003" persondesignation="Trade Instructor" />
                                    <PersonDetails personimage="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/default.png?alt=media&token=9c4eb775-02ac-4ad0-bbb8-0eb8a7cffa14" personname="VISHNU J" personnumber="7907455144" persondesignation="Trade Instructor" personemail=" vishnucpt@gmail.com"/>
                                </div>
                            </div>
                        </div>
                    </div>
                <div className={darkMode?"d-flex p-3 text-info bg-dark border border-white border-1 mb-5 departmentcontainer":"d-flex p-3 text-white bg-primary mb-5 departmentcontainer"}> 
                    <div className="mb-5"><img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/hari.jpg?alt=media&token=27eba142-0b4b-4a62-8e36-6682d67149f9" width="150px" height="150px" alt="Haripriya" /></div>
                    <div>
