  ...
  return (
    <div>
        <div>
          ...
          <div><FixedNavbar/></div>
          <div className={darkMode?"bg-dark p-5 text-warning":"bg-primary p-5 text-white"}><h2>Department of Mechanical Engineering</h2></div>
            ...
            <div className="p-3">
                ...
                <div className="physicaldepartment p-3">
                    <div className="cardcontainer">
                        ...
                        <div className={darkMode?"mb-5 p-3 text-info":"mb-5 p-3"}><p><i>Identify ourselves as a globally recognized department for its outstanding education, research, and outreach</i></p></div>
                        <div className="mb-5 ">
                            <p>
                ...
                <div className="mb-3">
                        ...
                        <div class="collapse" id="collapseExample1">
                            <div class={darkMode?"card card-body bg-dark border-white border-1 border":"card card-body"}>
                                ...
                                <div className={darkMode?"text-info":"text-secondary"}><p>To train students with solid foundation in mathematics, science and engineering to develop innovative and sustainable solutions for engineering problems and new products.</p></div>
                                <div className={darkMode?"text-success":"text-primary"}><h4><u>PEO 3</u></h4></div>
                                <div className={darkMode?"text-info":"text-secondary"}><p>To equip students with the necessary skills, attitudes and ethics to undertake and execute challenging problems based on societal and environmental needs as well as to develop ability to relate engineering issues in a broader social context.</p></div>
                                <div className={darkMode?"text-success":"text-primary"}><h4><u>PEO 4</u></h4></div>
                                <div className={darkMode?"text-info":"text-secondary"}><p>To prepare students with capabilities for effective communication, management and team work through a multidisciplinary approach.</p></div>
                                <div className={darkMode?"text-success":"text-primary"}><h4><u>PEO 5</u></h4></div>
