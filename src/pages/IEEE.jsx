        ...
        <div>
          ...
          <div className={darkMode?"d-flex personcontainer3 p-3 bg-dark border-top border-1 border-primary":"d-flex p-3 personcontainer3"}>
            <div className="p-3">
                ...
                <div className="mb-3 text-center"><img src="logo.png" width="200px" height="200px" alt="ieee logo" /></div>
                ...
                <div className="mb-5 asmeimage"><img src="members.jpg" width="450px" height="350px" alt="IEEE Members" /></div>
