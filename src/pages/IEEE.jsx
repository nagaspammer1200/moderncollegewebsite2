        ...
        <div>
          ...
          <div className={darkMode?"d-flex personcontainer3 p-3 bg-dark border-top border-1 border-primary":"d-flex p-3 personcontainer3"}>
            <div className="p-3">
                ...
                <div className="mb-3 text-center"><img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/logo.png?alt=media&token=1d4c7b90-7901-4f7c-96ed-f4db29f3212d" width="200px" height="200px" alt="ieee logo" /></div>
                ...
                <div className="mb-5 asmeimage"><img src="https://firebasestorage.googleapis.com/v0/b/gecbhclone.appspot.com/o/members.jpg?alt=media&token=6958cb3f-f9c4-4845-9218-23dbcdc81f9a" width="450px" height="350px" alt="IEEE Members" /></div>
