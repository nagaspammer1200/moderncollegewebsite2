        ...
        <div>
          ...
          <div className="d-flex personcontainer2">
            <div className="nsscontainer p-2">
                ...
                <div className="mb-5 p-3"><p>AN internet Lab has been set up to supplement internet access facilities in the campus. This lab is also being used as the Language Lab for training first-year students. This lab has a server machine (Intel Xeon Octacore), 30 desktops, required software and accessories.</p></div>
                <div className="mb-5 p-3"><p>A core team of faculty and staff from IT department is managing and maintaining the day to day functionalities of CCF.</p></div>
