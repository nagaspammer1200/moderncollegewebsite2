  ...
  return (
    <div>
        <div>
          ...
          <div><FixedNavbar/></div>
          <div className="bg-primary p-5 text-white"><h2>Central Computing Facility</h2></div>
          <div className="d-flex personcontainer2">
            <div className="nsscontainer p-2">
                ...
                <div className="mb-2"><p>There are 7 server machines (2 IBM rack servers, 5 HP blade servers) in the server room, running on Windows Server and Centos Linux platforms. The lab facility contains 68 dual-bootable (Windows/Ubuntu) desktops. UPS support of 40 KVA (5*6 KVA + 10 KVA) is provided. The CCF manages the campus network, WiFi access and college website. It also provides support for DDFS (Digital Document Filing System) application in college office, QEEE activities, Centralized Allotment Process (CAP) of Commissioner of Entrance Examinations and collection of online feedback from students. Various online tests as part of campus recruitments and examinations organized by external agencies (Govt./Non Govt) such as Online PSC examinations , LLB entrance examinations etc are conducted at CCF.</p></div>
                <div className="mb-2"><p>The college is a member of the National Knowledge Network (NKN) which is a high-speed network backbone interconnecting major educational and research institutions. NKN is maintained by National Informatics Network (NIC), Government of India. NKN provides a bandwidth of 1000 Mbps (1 Gbps) to the college. In addition, a 16 Mbps internet connection has been taken from BSNL. This connection is being maintained as a backup to be used in the rare event of an NKN connection failure.</p></div>
                <div className="mb-2"><p>The network traffic between the college intranet and the internet is monitored and controlled through a firewall. Cisco routers and switches are used at the backbone level of the intranet. A fiber-optic backbone has been laid to provide connectivity to various parts of the campus.</p></div>
                <div className="mb-2"><p>The campus is completely connected by WiFi. A Ruckus ZoneDirector 3000 WiFi controller kept in the server room manages the WiFi access. Access points have been deployed throughout the campus so that online facilities like e-journals (which are provided on IP-based access) can be accessed from anywhere within the college premises.</p></div>
                <div className="mb-2"><p>AN internet Lab has been set up to supplement internet access facilities in the campus. This lab is also being used as the Language Lab for training first-year students. This lab has a server machine (Intel Xeon Octacore), 30 desktops, required software and accessories.</p></div>
                <div className="mb-2"><p>A core team of faculty and staff from IT department is managing and maintaining the day to day functionalities of CCF.</p></div>
                <div className="text-primary mb-5"><h3>Equipments and Softwares</h3></div>
