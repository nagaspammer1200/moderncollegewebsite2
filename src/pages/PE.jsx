            ...
            <div className="p-3">
                ...
                <div className="physicaldepartment p-3">
                    <div className="cardcontainer">
                        ...
                        <div className={darkMode?"mb-2 p-3 text-info":"mb-2 p-3"}><p><i>"To make a vibrant, leading-edge in the sports arena duly recognizing the students as the central character of all sporting activities;</i></p></div>
                        <div className="mb-5 ">
                            <p>
                    ...
                    <div className="cardcontainer">
                        ...
                        <div className={darkMode?"mb-2 p-3 text-info":"mb-2 p-3"}><p><i>"To provide equal opportunities to all students’ participation in sports.To promote excellence in sport with the athlete as the central character.</i></p></div>
                        <div>
                            <p>
