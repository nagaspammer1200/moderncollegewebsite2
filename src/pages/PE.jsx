  ...
  return (
    <div>
        <div>
          ...
          <div><FixedNavbar/></div>
          <div className="bg-primary p-5 text-white"><h2>Department of Physical Education</h2></div>
            ...
            <div className="p-3">
                ...
                <div className="physicaldepartment p-3">
                    ...
                    <div className="cardcontainer">
                        ...
                        <div className="mb-2 p-3"><p><i>"To provide equal opportunities to all students’ participation in sports.To promote excellence in sport with the athlete as the central character.</i></p></div>
                        <div>
                            <p>
                            ...
                            <div className="mb-5">
                                <div className="collapse collapse-horizontal" id="collapseWidthExample">
                                    ...
                                    To develop, maintain and optimally utilise high quality sports infrastructure. To encourage, train and support talented sports persons in large numbers. To lay special emphasis on strengthening of infrastructure in educational institutions. To create a culture of sports by imbibing higher moral and ethical values, spirit of sportsmanship and camaraderie and thereby raise the level of desire to excel among the students’ in the college. To channelize sports activities as a vehicle to help the people of the State to achieve at least a minimum level of physical fitness. To recognise talent in sports and reward them for achieving excellence in sports. To recognise special needs of the differentially abled and facilitate their participation in sports and games. To ensure autonomy in sports so much so the spirit of the Olympic Charter is respected. To take appropriate steps to encourage involvement of sports infrastructure, training and conduct of sports competition leading to broad basing of sports in the college."
                                    </div>
                                </div>
                            </div>
                        </div>
